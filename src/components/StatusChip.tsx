...
export default function StatusChip({ label, type, reminder }: StatusChipProps) {
  return (
    <div className="flex flex-col gap-1 items-start">
      <span className={`${statusColors[type]} text-white font-roboto font-bold text-sm leading-[18px] px-2 h-[25px] flex items-center justify-center rounded-full whitespace-nowrap`}>
        {label}
      </span>
      {reminder && (
